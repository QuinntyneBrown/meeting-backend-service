...
export class AppStore {
    ...
    public meetingById$(id: string): Observable<Meeting> {
        return this._store.select("meetings")
            .map((data: { meetings: Array<Meeting> }) => {
                return pluck({ value: id, items: data.meetings }) as Meeting;
            })
    }
