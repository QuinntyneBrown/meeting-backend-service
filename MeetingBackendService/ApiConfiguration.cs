...
using System;
using MeetingBackendService.App_Start;
using MeetingBackendService.Utilities;
using MeetingBackendService.Configuration;
using MeetingBackendService.Services;
using MeetingBackendService.Authentication;
using MeetingBackendService.Filters;

namespace MeetingBackendService
{
    public class ApiConfiguration
    {
        public static void Install(HttpConfiguration config, IAppBuilder app)
        {
            ...
            config
                .EnableSwagger(c => c.SingleApiVersion("v1", "MeetingBackendService"))
                .EnableSwaggerUi();
